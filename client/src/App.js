...
import MyCheeses from "./components/MyCheeses/index.js";
import CheeseMarketplace from "./components/CheeseMarketplace/index.js";
    ...
    return (
      <div className={styles.App}>
        <Header />
          ...
          {this.state.route === 'my-cheeses' && this.renderMyCheeses()}
          {this.state.route === 'cheese-marketplace' && this.renderCheeseMarketPlace()}
        <Footer />
      </div>
    );
  }
